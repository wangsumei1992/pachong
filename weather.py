...
class BaiduWeather:
    ...
    def today_css_selectors(self):
        today_main_class = '.op_weather4_twoicon_today .%s'
        return {
            'temp': today_main_class %('op_weather4_twoicon_temp'),
            'weather': today_main_class %('op_weather4_twoicon_weath'),
            'wind': today_main_class %('op_weather4_twoicon_wind')
        }

    @property
    def tomorrow_css_selectors(self):
        tomorrow_main_class = '.op_weather4_twoicon_today .%s'
        return {
            'temp': tomorrow_main_class % ('op_weather4_twoicon_temp'),
            'weather': tomorrow_main_class % ('op_weather4_twoicon_weath'),
            'wind': tomorrow_main_class % ('op_weather4_twoicon_wind')
        }
    ...
    def get_tomorrow_weather_vl(self):
        return {
